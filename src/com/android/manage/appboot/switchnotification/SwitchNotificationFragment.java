...
import com.android.manage.appboot.ManagerActivity;
...
//		Log.i(TAG, "onCreate");
//		System.out.println("SwitchNotificationFragment onCreate");
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.switchnotification_main, container, false);
		mSwitchAll = (Switch)rootView.findViewById(R.id.switch_all_Notifications);
		mSwitchAll.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				...
				Log.i(TAG, "onCheckedChanged switch all isChecked = " + isChecked);
		...
		mLayoutContainerLoading = (View)rootView.findViewById(R.id.loading_container);
		mLayoutContainerLoading.setVisibility(View.VISIBLE);
		lv_apps.setVisibility(View.INVISIBLE);
		Log.i(TAG, "onCreate");
...
//		System.out.println("SwitchNotificationFragment onCreateView");
		return rootView;
	}
	/**
...
//			Log.i(TAG, "initAppsList i = " + i);
	...
	public void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		System.out.println("SwitchNotificationFragment onPause");
	}
